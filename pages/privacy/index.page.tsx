    ...
    <>
      ...
      <section className="text-xl text-paragraph tracking-wider space-y-2 px-2 lg:px-10 min-h-screen">
        ...
        <ul>
          ...
          <li>
            <p>
              <strong>Application</strong> refers to UniqueMW, the software
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to UniqueMW.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Country</strong> refers to: Malawi
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to UniqueMW, accessible from{' '}
              <a
                href="https://uniquecocktailapp.netlify.app"
                rel="noreferrer"
                target="_blank"
              >
                uniquecocktailapp.netlify.app
              </a>
            </p>
          </li>
          <li>
