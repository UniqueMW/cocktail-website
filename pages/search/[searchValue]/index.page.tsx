      ...
      <section className="px-2 lg:px-10">
        <Grid drinks={drinks}>
          <section className="space-y-4">
            <h1 className="md:text-2xl text-xl text-paragraph text-center font-paragraph tracking-wider">
              Search Results Of: {props.searchValue}
            </h1>
            <div className="text-heading font-paragraph tracking-wider md:text-lg text-base text-bold flex flex-row justify-center space-x-6">
              <button
