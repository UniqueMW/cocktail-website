...
function Footer(): JSX.Element {
  return (
    <footer className="lg:px-10 px-2 w-full">
      <section className="flex flex-row justify-start items-center w-full space-x-4">
        <Logo />
        <NavLink href="/contact">Contact Me</NavLink>
        <NavLink href="/privacy">Privacy Policy</NavLink>
      </section>
      <section className="flex flex-row items-center justify-between border-t-2 border-t-action py-2">
        <h1 className="text-lg text-heading tracking-wider font-heading">
