...
function SearchBar(): JSX.Element {
  ...
  return (
    <button
      type="submit"
      className="flex flex-row items-center justify-between space-x-4 text-base text-heading font-heading tracking-wider bg-transparent border border-paragraph w-full sm:max-w-[70%] py-2 px-2 h-11"
